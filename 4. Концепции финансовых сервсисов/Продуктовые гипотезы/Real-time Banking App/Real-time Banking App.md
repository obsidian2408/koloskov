...
1. Для регулярных покупок, предложит инструменты оптимизации:
	1. Для цифровых: определить утечки бюджета и вернуть контроль над странами
	2. Для физических, сконфигурировать статистику по продуктовое корзине и предложить партнёра с лучшей ценой

2. Для запланированных:
	1. Предложить позаботиться заранее в периоды низкого спроса;
